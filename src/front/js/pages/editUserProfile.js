          ...
          <div className="row my-0 mx-2">
            {editMode == false ? (
              ...
              <>
                <p className="mb-0">
                  <b>Genre: </b>
                  <select className="form-control" id="artistMusicGenre">
            ...
            <div className="col-md-3 d-flex">
              {editMode == false ? (
                ...
                <>
                  <p className="mb-0">
                    <b>Capacity: </b>
                    <input type="number" value="999" id="venueCapacity"></input>
                  </p>
                </>
              )}
            </div>
